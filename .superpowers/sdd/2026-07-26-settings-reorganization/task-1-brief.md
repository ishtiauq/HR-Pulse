...
## Step 3: Verify
Run `npm run dev` (use `cmd /c "npm run dev"`) and check the dev server starts without errors. No automated tests exist for this UI change — visual verification is manual.
