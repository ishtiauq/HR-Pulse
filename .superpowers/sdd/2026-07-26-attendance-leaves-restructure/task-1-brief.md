...
## Context
This is Task 1 of 6 in the Attendance & Leaves restructure. We are decomposing the monolithic 883-line Attendance.jsx into focused hooks + extracted components. This task creates the shared utility file that all hooks and components will import from.

## Requirements
Create `src/services/attendance.js` with these exports (exact values verbatim from plan):
...
## Deliverable
- File: `src/services/attendance.js` — created with the exact exports above

## Report file
Write report to: `.superpowers/sdd/2026-07-26-attendance-leaves-restructure/task-1-report.md`
